...
cfg = "/opt/yunsheng/7-4/yunsheng/yolov3-voc-test.cfg"
model = "/opt/yunsheng/7-4/yunsheng/backup/yolov3-voc_6000.weights"
data = "/opt/yunsheng/7-4/yunsheng/voc.data"
save_path = "/opt/yunsheng/7-4/yunsheng/test-result/" # 检测结果保存路径 以 / 结尾
img_path = "/opt/yunsheng/7-4/yunsheng/JPEGImages/" # 检测的图片路径 以 / 结尾
img_ext = "*.jpg" # 图片格式
