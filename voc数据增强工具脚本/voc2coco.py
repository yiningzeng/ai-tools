...
class PascalVOC2coco(object):
    ...
    def annotation(self):
        ...
        points = [self.bbox[0],self.bbox[1],self.bbox[0]+self.bbox[2],self.bbox[1],self.bbox[0],self.bbox[1]+self.bbox[3],self.bbox[0]+self.bbox[2],self.bbox[1]+self.bbox[3]]
        annotation['segmentation']=[points]
        #annotation['segmentation']=[list(np.asarray(points).flatten())]
        annotation['area'] = float(self.bbox[2]*self.bbox[3])
